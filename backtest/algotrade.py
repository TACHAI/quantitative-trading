...
class MyStrategy(strategy.BacktestingStrategy):
    def __init__(self, feed, instrument, smaPeriod1, smaPeriod2):
        ...
        self.__sma1 = ma.SMA(feed[instrument].getCloseDataSeries(),smaPeriod1)
        self.__sma2 = ma.SMA(feed[instrument].getCloseDataSeries(),smaPeriod2)
...
def run_strategy(smaPeriod1, smaPeriod2):
    ...
    # Evaluate the mystrategy with the feed's bars.
    ...
    # 可视化部分
    # Attach a returns analyzers to the mystrategy.
    returnsAnalyzer = returns.Returns()
    myStrategy.attachAnalyzer(returnsAnalyzer)

    # Attach the plotter to the mystrategy.
